...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(280, 0, 131, 81))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(80, 250, 71, 16))
        self.label_3.setObjectName("label_3")
        self.txt_info = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(170, 130, 551, 87))
        self.txt_info.setObjectName("txt_info")
        self.txt_sign = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(150, 250, 571, 87))
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(490, 30, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_gen_keys.setText(_translate("MainWindow", "genrrate keys"))
