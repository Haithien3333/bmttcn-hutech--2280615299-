...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_sign.clicked.connect(self.call_api_sign)  # Đúng nút
        self.ui.btn_verify.clicked.connect(self.call_api_verify)

    def call_api_gen_keys(self):
        url = 'http://127.0.0.1:5000/api/rsa/gen_keys'
...
class RSACipher:
    def __init__(self):
        pass  # Constructor mặc định

    def encrypt(self, message, public_key):
        pass  # Hàm mã hóa (placeholder)

    def decrypt(self, ciphertext, private_key):
        pass  # Hàm giải mã (placeholder)
