...
class Blockchain:
    ...
    def proof_of_work(self, previous_proof):
        """Tính toán Proof of Work (PoW) để đảm bảo tính bảo mật của blockchain."""
        new_proof = 1
        check_proof = False
        while not check_proof:
            # Hàm băm kiểm tra hợp lệ
    ...
    def add_transaction(self, sender, receiver, amount):
        """Thêm giao dịch mới vào danh sách giao dịch hiện tại."""
    ...
    def is_chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            if block.previous_hash != previous_block.hash:
                return False
            # Kiểm tra Proof of Work của block
